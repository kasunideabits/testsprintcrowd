...
{
    public class UserDeclinedRequest : IUserDeclinedRequest
    {
        private ScrowdDbContext Context { get; }
        private IPushNotificationClient PushNotificationClient { get; }

        public UserDeclinedRequest(ScrowdDbContext context, IPushNotificationClient client, ISprintParticipantRepo sprintParticipantRepo)
        {

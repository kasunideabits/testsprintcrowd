...
namespace SprintCrowdBackEnd.Migrations
{
    ...
    [Migration("20220328065822_20220328_DistanceRanUnCompleted")]
    partial class _20220328_DistanceRanUnCompleted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SprintCrowd.BackEnd.Infrastructure.Persistence.Entities.ProgramParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
                    ...
                    b.Property<int?>("SprintProgramId")
                        .HasColumnName("sprint_program_id");
                    ...
                    b.HasIndex("SprintProgramId");

                    b.HasIndex("UserId");

                    b.ToTable("program_participant");
                });
            ...
            modelBuilder.Entity("SprintCrowd.BackEnd.Infrastructure.Persistence.Entities.SprintParticipant", b =>
                {
                    ...
                    b.Property<int>("DistanceRanUnCompleted")
                        .HasColumnName("distance_ran_un_completed");
            ...
            modelBuilder.Entity("SprintCrowdBackEnd.Infrastructure.Persistence.Entities.SprintProgram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
                    ...
                    b.Property<string>("GetSocialLink")
                        .HasColumnName("get_social_link");
                    ...
                    b.Property<bool>("IsPromoteInApp")
                        .HasColumnName("is_promote_in_app");
            ...
            modelBuilder.Entity("SprintCrowd.BackEnd.Infrastructure.Persistence.Entities.ProgramParticipant", b =>
                {
                    b.HasOne("SprintCrowdBackEnd.Infrastructure.Persistence.Entities.SprintProgram", "SprintProgram")
                        .WithMany()
                        .HasForeignKey("SprintProgramId");

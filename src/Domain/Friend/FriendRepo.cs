namespace SprintCrowd.BackEnd.Domain.Friend
{
    ...
    public class FriendRepo : IFriendRepo
    {
        ...
        {
            var res = await this.dbContext.Frineds.FirstOrDefaultAsync(u => (u.AcceptedUser.Equals(acceptedId) && u.SharedUserId.Equals(sharedId)));
            return res;
        }
        ...
        public async Task<List<Friend>> GetAllFriends(int userId)
        {
            return await this.dbContext.Frineds
                ...
                .Where(s => (s.AcceptedUserId == userId || s.SharedUserId == userId)).ToListAsync();
            //&&
        ...
        /// <returns></returns>
        public async Task<Friend> GetFriendship(int userId)
        {
            return await this.dbContext.Frineds

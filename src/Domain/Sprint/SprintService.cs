namespace SprintCrowd.BackEnd.Domain.Sprint
{
    ...
    public class SprintService : ISprintService
    {
        ...
        private async Task<string> PopulateEmailBody(Sprint sprint , string repeatType )
        {
            ...
            leaderBoarLink = "https://https://admin.sprintcrowd.com/control-panel/dashboard/leader_board?id=" + sprint.Id + "&name=" +sprint.Name+ "&stratTime="+ sprint.StartDateTime+ "&token=share";

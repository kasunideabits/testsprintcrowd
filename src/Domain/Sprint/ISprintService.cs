namespace SprintCrowd.BackEnd.Domain.Sprint
{
    ...
    public interface ISprintService
    {
        ...
        /// <param name="influencerAvailability">influencer available or not</param>
        /// <returns>cereated sprint</returns>
        Task<CreateSprintDto> CreateNewSimulation(User user, string name, int distance, DateTime startTime, int type, int? numberOfParticipants, string infulenceEmail, int draft, bool influencerAvailability);
